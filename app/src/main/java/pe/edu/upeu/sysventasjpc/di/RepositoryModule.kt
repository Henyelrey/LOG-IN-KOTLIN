...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun productoRepository(
        prodRepos:
        ProductoRepositoryImp
    ): ProductoRepository

    @Binds
    @Singleton
    abstract fun marcaRepository(marcaRepos: MarcaRepositoryImp):
            MarcaRepository
    ...
    abstract fun categoriaRepository(
        categoriaRepos:
        CategoriaRepositoryImp
    ): CategoriaRepository

    @Binds
    @Singleton
    abstract fun unidadMedRepository(
        unidmedRepos:
        UnidadMedidaRepositoryImp
